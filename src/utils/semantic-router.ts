...
const KEYWORD_MAP: Record<string, CategoryFiles> = {
  ...
  'sql': { skills: ['database.md'] },
  'database': { skills: ['database.md'] },
  'db schema': { skills: ['database.md'] },
  'database schema': { skills: ['database.md'] },
  'sql migration': { skills: ['database.md'] },
  'database migration': { skills: ['database.md'] },
